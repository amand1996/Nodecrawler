...
//   var output1 = "Max pages to visit: " + MAX_PAGES_TO_VISIT + "<br>";
//
//   var pagesVisited = {};
//   var numPagesVisited = 0;
//   var pagesToVisit = [];
...
//   function crawl() {
//     if(numPagesVisited >= MAX_PAGES_TO_VISIT) {
//       output1 = output1 + "Reached max limit of number of pages to visit." + "<br>";
...
//     output = output + "Visiting page " + url + "<br>";
//     request(url, function(error, response, body) {
//        console.log("Status code: " + response.statusCode);
//        if(response.statusCode !== 200) {
//          callback();
...
//          output1 = output1 + 'Word ' + SEARCH_WORD + ' found at page ' + url + "<br>";
//          collectInternalLinks($);
//          callback();
//        } else {
//          collectInternalLinks($);
...
//       output1 = output1 + "Found " + relativeLinks.length + " relative links on page" + "<br>";
//       relativeLinks.each(function() {
//           pagesToVisit.push(baseUrl + $(this).attr('href'));
//       });
//   }
